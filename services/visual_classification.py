...
VISUAL_VERSION = "visual-examination@8"
...
VISUAL_VERSION_HISTORY = ("visual-examination@1", "visual-examination@2",
                          "visual-examination@3", "visual-examination@4", "visual-examination@5", "visual-examination@6", "visual-examination@7")
    ...
    for attempt in range(5):
        ...
        try:
            ...
            try:
                ...
                from services.survey_north import propose_conversions

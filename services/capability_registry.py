...
MUSCLE_CONTRACTS = {
    ...
    'services.cross_modal_investigation.inspect_interpretation_drift': _muscle('INTERPRETATION DRIFT',
        'Two anchored typed propositions, confirmed dependency and applicability date', 'Wording, meaning, authorization and governed drift states',
        'Reviewed same-scope meaning -> preserved or changed; separate reviewed transition authorization', 'UNRESOLVED, REFUSED, CONFLICTING',
        'Paraphrase is not drift. Missing authorization is not positive prohibition. Normalization cannot establish unrecorded meaning.'),

...
class DeepOceanPaletteTests(_BaseTestCase):
    ...
    def test_ocean_tokens_are_a_literal_copy_of_gateway_shells_own_rule(self):
        ...
        pairs = (
            ...
            ("--ocean-surface-hover", "rgba(176, 255, 244, .12)"),
            ("--ocean-surface-selected", "rgba(176, 255, 244, .18)"),
            ("--ocean-border", "rgba(176, 255, 244, .28)"),
            ("--ocean-border-strong", "rgba(176, 255, 244, .5)"),
            ("--ocean-text-primary", "rgb(230, 255, 251)"),
            ("--ocean-text-secondary", "rgba(228, 255, 251, .82)"),
            ("--ocean-text-metadata", "rgba(200, 255, 248, .72)"),
            ("--ocean-text-disabled", "rgba(200, 255, 248, .4)"),
            ("--ocean-machine-blue", "rgba(200, 255, 248, .8)"),

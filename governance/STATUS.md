...
| `CaseLock`, Derive/Copy/Adopt, publication anchoring | **NOT AUTHORIZED** — specified only; explicitly *not* implied by the rows above. See `specified-unbuilt/investigation-lifecycle-extensions.md`. |

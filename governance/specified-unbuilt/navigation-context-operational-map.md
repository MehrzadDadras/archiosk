...
label fix) is accurate as of the commit immediately following it in
`git log`, live-deployed and live-verified on both operating
environments as of 2026-08-17. If the referenced file/line has since
changed, the row's own confidence should be treated as stale until
re-verified, not trusted at face value.

...
explicit 2026-08-17 Product Owner disposition (see row 32); rows 34-35
...
lifecycle) as of 2026-08-17 - not yet deployed/activated at the time
this row was written (see the round's own report for current state).
Once activated by the Product Owner, this mechanism is what row 32's
three still-open items are waiting on. If the

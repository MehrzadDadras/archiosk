...
| CIC-SPIN-INTELLIGENCE | v1.2 | CURRENT | Spin evidence, prompts, model calls, findings, provenance, Helix assessment, or Multi-Observer Shear | [Record](CIC-SPIN-INTELLIGENCE-v1.2.md) |

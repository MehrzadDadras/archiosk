...
|---|---|---|---|---|---|---|---|---|---|
| TPL-001 | Home / project selection | `portal.index` `/` | `index.html`, `base.html` | app menu, `developer_composer_input.js`, `voice_input.js` | Normal Gateway orientation: yes / yes. Developer Composer: yes / yes. | Developer home Composer is application-scoped; `/CCN` supported. | Project/environment content; Developer Mode and CCN indicators. | `test_developer_home_composer_01.py`, `test_home_navigation_shell.py`; **REFERENCE** for application Composer. | Normal orientation remains deterministic; direct visual selection is future work. |

...
11. **Private work stays private until deliberately shared.** Visibility is an explicit permission transition, never an automatic consequence of creating professional work. The machine can work around the human, help the human, and discover for the human — but it cannot silently expose the human's unfinished thinking. As machine capability to detect, double-check, widen attention, and work ahead of the human increases, the human-controlled privacy boundary becomes more important, not less. Machine assistance, discovery, inference, analysis, or preparation for collaboration does not constitute authorization to publish, reveal, or share private work.

...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Composer draft preservation, submit status and thread scroll memory:
    // MOVED to static/js/go_composer.js, the one owner of the canonical Composer.
    ...
    // Composer voice: MOVED to static/js/go_composer.js (UNIVERSAL COMPOSER INVARIANT).

...
def run_spin_route(project_id):
    ...
    if not result.ran:
        store.record_spin_run(
            ...
            scoped_source_ids=[],
            evidence_sources_considered=result.evidence_sources_considered,
            evidence_sources_included=result.evidence_sources_included,
            evidence_items_considered=result.evidence_items_considered,
            total_evidence_items_budgeted=result.total_evidence_items_budgeted,
            evidence_chars_budgeted=result.evidence_chars_budgeted,
